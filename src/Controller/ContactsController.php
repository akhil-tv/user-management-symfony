...
class ContactsController extends AbstractController
{
    ...
    /**
     * @Route("show/{id}", name="app_contacts_show", methods={"GET"})
     */
    ...
    /**
     * @Route("/{id}", name="app_contacts_delete", methods={"GET","POST"})
     */
    public function delete(ContactsRepository $contactsRepository,$id): Response
    {
        $contact = $contactsRepository->findOneBy(['id' =>$id ]);
        try {
